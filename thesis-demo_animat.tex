...
%\marginpar{\RaggedRight Indeed, most of the early artificial life research was based on the cellular automaton, Conway's `Game of Life' \cite{gardner:1970} and Langton's self-reproducing loop \cite{langton:1984} being the most renown examples \cite{adami:1998,emmenche:1994,rucker:1993}.}
...
%
However, according to Mraz \cite{mraz:2000}, the abstract structure that is the most suitable for modelling a cell in the cellular automaton is the \sidenote{Moore automaton}{v1.1.20050210 [FHH]: would it be possible to have, as a footnote or box or something, a simple English explanation of this for biologists?} \cite{kohavi:1978}. 
...
%
%\printinunitsof{in}
%pW=\prntlen{\pageW}, pH=\prntlen{\pageH}, gW=\prntlen{\gridW}, gH=\prntlen{\gridH}, mI=\prntlen{\marginI}, mO=\prntlen{\marginO}, mT=\prntlen{\marginT}, mB=\prntlen{\marginB}, mpW=\prntlen{\marginparwidth}, mpS=\prntlen{\marginparsep}
%
%\printinunitsof{pt}
%pW=\prntlen{\pageW}, pH=\prntlen{\pageH}, gW=\prntlen{\gridW}, gH=\prntlen{\gridH}, mI=\prntlen{\marginI}, mO=\prntlen{\marginO}, mT=\prntlen{\marginT}, mB=\prntlen{\marginB}, mpW=\prntlen{\marginparwidth}, mpS=\prntlen{\marginparsep}
%
...
%pW=\prntlen{\pageW}, pH=\prntlen{\pageH}, gW=\prntlen{\gridW}, gH=\prntlen{\gridH}, mI=\prntlen{\marginI}, mO=\prntlen{\marginO}, mT=\prntlen{\marginT}, mB=\prntlen{\marginB}, mpW=\prntlen{\marginparwidth}, mpS=\prntlen{\marginparsep}
%
%\printinunitsof{mm}textwidth=\prntlen{\textwidth} textheight=\prntlen{\textheight}
%
%\printinunitsof{pt}baselineskip=\prntlen{\baselineskip} topskip=\prntlen{\topskip}
%\printinunitsof{pt}textwidth=\prntlen{\textwidth} textheight=\prntlen{\textheight}
%
%\the\textwidth
%
%\begin{figure}
...
& \set{N}_\mathrm{s}=\left\{i|\ i \in \N_n,\ i \neq j,\ \varepsilon_i%(q,y_i)
 \leq r_\mathrm{s},\ \varphi_i%(q,y_i)
 < \fov_\mathrm{s} \right\}, & \\ 
...
& \set{N}_\mathrm{a}=\left\{i|\ i \in \N_n,\ i \neq j,\ \varepsilon_i%(q,y_i)
 \leq r_\mathrm{a},\ \varphi_i%(q,y_i)
 < \fov_\mathrm{a}\right\}, & \\ 
...
& \set{N}_\mathrm{c}=\left\{i|\ i \in \N_n,\ i \neq j,\ \varepsilon_i%(q,y_i)
 \leq r_\mathrm{c},\ \varphi_i%(q,y_i)
 < \fov_\mathrm{c}\right\}, & \\
...
%Furthermore, as the original model presented by Heppner and Grenander was two-dimensional I shall assume $\E=\R^2$. Nevertheless, all equations work also for $\E=\R^3$ but running the simulations in three-dimensions with the same parameter values would probably result in a different behaviour. 
...
Let the animat employ only the omnidirectional perception function. Then $P=\langle P_\mathrm{o} \rangle$ and, according to definitions~\ref{def:animat:Dj} and \ref{def:animat:Po:fhh}, the set representing information obtainable from the perceivable state of the universe is $\set{P}=\set{P}^\mathrm{o}$.
