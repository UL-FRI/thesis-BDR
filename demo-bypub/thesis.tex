...
% TODO: ?\setkeys{Gin}{width=\figurewidth}
% TODO if press HQ else LQ
% load path for graphics files
\graphicspath{{img_HQ/}} % use high qualty figures - for press
%\graphicspath{{img_LQ/}} % use low quality figures - reduce file size for email
